			...
			<div className="container mx-auto px-4">
				<div className="flex flex-wrap text-center lg:text-left">
					<div className="w-full lg:w-6/12 px-4">
						...
						<div className="mt-6 lg:mb-0 mb-6 flex items-center sm:justify-normal justify-center">
							...
							<button className="text-xs ml-2 bg-blue-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded w-[36px] h-[36px]">
								Zalo
							</button>
						</div>
					</div>
						...
						<div className="flex flex-wrap items-top mb-6">
							<div className="w-full lg:w-4/12 px-4 ml-auto">
								...
								<ul className="list-unstyled">
									<li>
										<a className="text-blueGray-600 hover:text-blueGray-800 font-normal block pb-2 text-sm" href="https://www.creative-tim.com/presentation?ref=njs-profile">Fanpage <span>Khói 42</span></a>
									</li>
									<li>
										<a className="text-blueGray-600 hover:text-blueGray-800 font-normal block pb-2 text-sm" href="#">Zalo: 0707173999</a>
									</li>
								</ul>
							</div>
						</div>
